...
<h1 className='font-bold lg:text-5xl text-[1.7rem] mb-5'>At Loka, our distinctiveness is our USP,</h1>
...
<p className='w-full max-w-75 font-light text-black text-shadow-[0px_0px_1px_black] text-[1.15rem]'>{item.text}</p>
</div>
