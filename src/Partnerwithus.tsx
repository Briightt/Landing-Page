...
<li key = {index} className="flex items-center justify-between gap-5 text-[1.1rem] border-b leading-10 cursor-pointer w-full sm:max-w-130 sm:min-w-130 xl:max-w-90 xl:min-w-90 select-none 
