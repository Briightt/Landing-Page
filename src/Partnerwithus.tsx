...
<motion.h2 className="w-full max-w-120 text-white text-[1.3rem] lg:text-[1.2rem] lg:min-w-110 xl:max-w-120 leading-10 font-light" variants = {variants}>Partnering with a trusted sand company ensures a <span className="font-bold">consistent supply</span> of <span className="font-bold">high-quality, screened</span>,
...
<li  key = {index} className="flex items-center sm:justify-between justify-around gap-5 text-[1.1rem] border-b leading-10 cursor-pointer w-full sm:max-w-130 sm:min-w-130 lg:max-w-70 lg:min-w-70 xl:max-w-130 xl:min-w-130 select-none 
