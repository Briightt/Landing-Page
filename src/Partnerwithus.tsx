...
<li  key = {index} className="flex items-center sm:justify-between justify-around gap-5 text-[1.1rem] border-b leading-10 cursor-pointer w-full sm:max-w-130 sm:min-w-130 lg:max-w-80 lg:min-w-80 xl:max-w-130 xl:min-w-130 select-none 
